...
$module_menu[] = array(
        'index.php?module=Project&action=rentabilidadProyectos',
        isset($mod_strings['LNK_RENTABILIDAD_PROYECTOS']) ? $mod_strings['LNK_RENTABILIDAD_PROYECTOS'] : 'Informe de Rentabilidad',
        'Project'
    );

$module_menu[] = array(
        'index.php?module=Project&action=reporte_detalle_form',
        isset($mod_strings['LNK_PROYECCION_PROYECTOS']) ? $mod_strings['LNK_PROYECCION_PROYECTOS'] : 'Proyecciones de Facturaci&oacute;n',
        'Project'
    );
?>
