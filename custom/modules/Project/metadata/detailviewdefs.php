    ...
    array (
      ...
      array (
        ...
        array (
          ...
          3 => 
          array (
            'customCode' => '<input type="button" name="act_proy" value="Informe de Actividades" onclick="window.open(\'index.php?entryPoint=repProyAct&p_id={$fields.id.value}\',\'Informe de Actividades\',\'width=800,height=600,scrollbars=1\');" />',
          ),
        ),
      ),
      'useTabs' => true,
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'label' => 'LBL_OPPORTUNITIES_PROJECT_1_FROM_OPPORTUNITIES_TITLE',
          ),
          1 => 
          array (
      ...
      array (
        ...
        array (
          ...
          array (
            'name' => 'avance',
            'label' => 'LBL_AVANCE',
            'customCode' => '{assign var=reporinfo value=$fields.id.value|datos_proyecto}{$reporinfo.facturado / $fields.valor.value}%',
          ),
        ),
        1 => 
        array (
          ...
          array (
            ...
            'customCode' => '$ {$reporinfo.facturado|number_format:0}',
          ),
          1 => 
          array (
            'name' => 'horas_proyecto',
        ...
        array (
          ...
          array (
            ...
            'label' => 'LBL_VALOR_MANO_OBRA_HORAS_COTIZADO',
