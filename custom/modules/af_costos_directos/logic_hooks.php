...
$hook_array['before_save'][] = Array(1, 'calcula_costo', 'custom/modules/af_costos_directos/functions.php','functions', 'subtotal');  
$hook_array['before_save'][] = Array(2, 'calcula_cotizacion', 'custom/modules/af_costos_directos/functions.php','functions', 'valor_cot');  
