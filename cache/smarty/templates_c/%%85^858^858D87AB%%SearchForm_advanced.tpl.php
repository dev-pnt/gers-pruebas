<?php /* Smarty version 2.6.11, created on 2013-02-14 10:07:52
         compiled from cache/modules/Accounts/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Accounts/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/Accounts/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Accounts/SearchForm_advanced.tpl', 44, false),array('function', 'html_options', 'cache/modules/Accounts/SearchForm_advanced.tpl', 156, false),array('function', 'sugar_getimage', 'cache/modules/Accounts/SearchForm_advanced.tpl', 539, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='identificacion_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_IDENTIFICACION','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['identificacion_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['identificacion_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['identificacion_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['identificacion_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['identificacion_advanced']['name']; ?>
' size='30' 
    maxlength='20' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='prefijo_consecutivo_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PREFIJO_CONSECUTIVO','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['prefijo_consecutivo_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['prefijo_consecutivo_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['prefijo_consecutivo_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['prefijo_consecutivo_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['prefijo_consecutivo_advanced']['name']; ?>
' size='30' 
    maxlength='10' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='tipo_identificacion_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TIPO_IDENTIFICACION','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'tipo_identificacion_advanced','name' => 'tipo_identificacion_advanced[]','options' => $this->_tpl_vars['fields']['tipo_identificacion_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['tipo_identificacion_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='razon_social_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_RAZON_SOCIAL','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['razon_social_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['razon_social_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['razon_social_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['razon_social_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['razon_social_advanced']['name']; ?>
' size='30' 
    maxlength='36' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
