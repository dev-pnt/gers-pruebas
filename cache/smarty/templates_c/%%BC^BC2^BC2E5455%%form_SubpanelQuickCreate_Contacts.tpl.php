<?php /* Smarty version 2.6.11, created on 2013-02-14 10:08:36
...
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'date_entered_date\', \'date\', false,\'Fecha de Creación\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'date_modified_date\', \'date\', false,\'Fecha de Modificación\' );
...
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'twitter\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TWITTER','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'correos_gers\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CORREOS_GERS','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'tips_del_trato\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TIPS_TRATO','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'posicion_gers\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_POSICION_GERS','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'contacto_area\', \'multienum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTO_AREA','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'rol_negociacion\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ROL_NEGOCIACION','module' => 'Contacts','for_js' => true), $this); echo '\' );
