<?php /* Smarty version 2.6.11, created on 2013-02-14 11:08:17
         compiled from cache/modules/Cases/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Cases/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/Cases/DetailView.tpl', 38, false),array('function', 'sugar_getimagepath', 'cache/modules/Cases/DetailView.tpl', 41, false),array('function', 'sugar_translate', 'cache/modules/Cases/DetailView.tpl', 44, false),array('function', 'sugar_ajax_url', 'cache/modules/Cases/DetailView.tpl', 165, false),array('modifier', 'strip_semicolon', 'cache/modules/Cases/DetailView.tpl', 58, false),array('modifier', 'escape', 'cache/modules/Cases/DetailView.tpl', 318, false),array('modifier', 'url2html', 'cache/modules/Cases/DetailView.tpl', 318, false),array('modifier', 'nl2br', 'cache/modules/Cases/DetailView.tpl', 318, false),)), $this); ?>
...
" id="merge_duplicate_button"><?php endif; ?> </li><li><input title="<?php echo $this->_tpl_vars['MOD']['LBL_CREATE_KB_DOCUMENT']; ?>
" accessKey="M" class="button" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Cases'; _form.return_action.value='DetailView';_form.action.value='EditView';_form.module.value='KBDocuments';_form.submit();" name="button" type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_CREATE_KB_DOCUMENT']; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['canal_ingreso']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CANAL_INGRESO','module' => 'Cases'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['canal_ingreso']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['canal_ingreso']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['canal_ingreso']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['canal_ingreso']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['canal_ingreso']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['canal_ingreso']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['canal_ingreso']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['canal_ingreso']['options'][$this->_tpl_vars['fields']['canal_ingreso']['value']]; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['fecha_respuesta']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_FECHA_RESPUESTA','module' => 'Cases'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['fecha_respuesta']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['fecha_respuesta']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['fecha_respuesta']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['fecha_respuesta']['value']);  endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['fecha_respuesta']['name']; ?>
...
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['fecha_est_solucion']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['fecha_est_solucion']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['fecha_est_solucion']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['fecha_est_solucion']['value']);  endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['fecha_est_solucion']['name']; ?>
"><?php echo $this->_tpl_vars['value']; ?>
</span>
<?php endif; ?>
</td>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['satisfecho']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SATISFECHO','module' => 'Cases'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['satisfecho']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<input type="checkbox" class="checkbox" name="<?php echo $this->_tpl_vars['fields']['satisfecho']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['satisfecho']['name']; ?>
" value="$fields.satisfecho.value" disabled="true" <?php echo $this->_tpl_vars['checked']; ?>
>
<?php endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['fecha_solucion']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_FECHA_SOLUCION','module' => 'Cases'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['fecha_solucion']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['fecha_solucion']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['fecha_solucion']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['fecha_solucion']['value']);  endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['fecha_solucion']['name']; ?>
"><?php echo $this->_tpl_vars['value']; ?>
</span>
<?php endif; ?>
</td>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['solucion']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SOLUCION','module' => 'Cases'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%' colspan='3' >
<?php if (! $this->_tpl_vars['fields']['solucion']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<span class="sugar_field" id="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['solucion']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
