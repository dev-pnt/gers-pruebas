<?php /* Smarty version 2.6.11, created on 2013-02-14 09:48:51
         compiled from cache/modules/ProjectTask/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/ProjectTask/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/ProjectTask/EditView.tpl', 50, false),array('function', 'sugar_translate', 'cache/modules/ProjectTask/EditView.tpl', 56, false),array('function', 'sugar_getimage', 'cache/modules/ProjectTask/EditView.tpl', 95, false),array('function', 'sugar_getimagepath', 'cache/modules/ProjectTask/EditView.tpl', 173, false),array('function', 'html_options', 'cache/modules/ProjectTask/EditView.tpl', 198, false),array('function', 'sugar_number_format', 'cache/modules/ProjectTask/EditView.tpl', 518, false),array('modifier', 'strip_semicolon', 'cache/modules/ProjectTask/EditView.tpl', 57, false),array('modifier', 'default', 'cache/modules/ProjectTask/EditView.tpl', 105, false),array('modifier', 'lookup', 'cache/modules/ProjectTask/EditView.tpl', 239, false),array('modifier', 'count', 'cache/modules/ProjectTask/EditView.tpl', 319, false),)), $this); ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_USER_NAME','module' => 'ProjectTask'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_NAME','module' => 'ProjectTask'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['anticipos']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['anticipos']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['anticipos']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['anticipos']['name']; ?>
'
id='<?php echo $this->_tpl_vars['fields']['anticipos']['name']; ?>
'
size='30'
...
addToValidate(\'EditView\', \'project_id\', \'id\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_ID','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'project_task_id\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_TASK_ID','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'status\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'predecessors\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PREDECESSORS','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidateDateBeforeAllowBlank(\'EditView\', \'date_start\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_START','module' => 'ProjectTask','for_js' => true), $this); echo '\', \'date_finish\', \'true\' );
addToValidate(\'EditView\', \'time_start\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TIME_START','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'time_finish\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TIME_FINISH','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_finish\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_FINISH','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'duration\', \'int\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DURATION','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'duration_unit\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DURATION_UNIT','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'actual_duration\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACTUAL_DURATION','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'percent_complete\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PERCENT_COMPLETE','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_due\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_DUE','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'time_due\', \'time\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TIME_DUE','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'parent_task_id\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PARENT_TASK_ID','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_USER_ID','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_USER_ID','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'priority\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIORITY','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED_BY','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'milestone_flag\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MILESTONE_FLAG','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'order_number\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ORDER_NUMBER','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'task_number\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TASK_NUMBER','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'estimated_effort\', \'float\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ESTIMATED_EFFORT','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'actual_effort\', \'float\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACTUAL_EFFORT','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidateRange(\'EditView\', \'utilization\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_UTILIZATION','module' => 'ProjectTask','for_js' => true), $this); echo '\', 0, 100 );
addToValidate(\'EditView\', \'project_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PARENT_NAME','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'escalafon\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ESCALAFON','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_USER_NAME','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'anticipos\', \'float\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ANTICIPOS','module' => 'ProjectTask','for_js' => true), $this); echo '\' );
addToValidateBinaryDependency(\'EditView\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'ProjectTask','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'ProjectTask','for_js' => true), $this); echo '\', \'assigned_user_id\' );
addToValidateBinaryDependency(\'EditView\', \'project_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'ProjectTask','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_PARENT_NAME','module' => 'ProjectTask','for_js' => true), $this); echo '\', \'project_id\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_assigned_user_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'EditView_project_name\']={"form":"EditView","method":"query","modules":["Project"],"group":"or","field_list":["name","id"],"populate_list":["project_name","project_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};</script>'; ?>
