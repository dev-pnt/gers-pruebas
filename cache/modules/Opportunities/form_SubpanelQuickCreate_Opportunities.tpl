...
{/literal}
{/if}
<td valign="top" id='valor_real_label' width='12.5%' scope="col">
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'date_entered_date', 'date', false,'Fecha de Creación' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'date_modified_date', 'date', false,'Última Modificación' );
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'amount', 'currency', false,'{/literal}{sugar_translate label='LBL_AMOUNT' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'date_created', 'date', true,'{/literal}{sugar_translate label='LBL_DATE_CREATED' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'date_cotizacion', 'date', false,'{/literal}{sugar_translate label='LBL_DATE_COTIZACION' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'date_request', 'date', true,'{/literal}{sugar_translate label='LBL_DATE_REQUEST' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'date_award', 'date', true,'{/literal}{sugar_translate label='LBL_DATE_AWARD' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'date_real_adjudicacion', 'date', false,'{/literal}{sugar_translate label='LBL_DATE_REAL_ADJUDICACION' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'razones_perdida', 'enum', false,'{/literal}{sugar_translate label='LBL_RAZONES_PERDIDA' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'departamento_encargado', 'enum', true,'{/literal}{sugar_translate label='LBL_DEPARTAMENTO_ENCARGADO' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'departamento_costos', 'enum', false,'{/literal}{sugar_translate label='LBL_DEPARTAMENTO_COSTOS' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'probabilidad', 'enum', false,'{/literal}{sugar_translate label='LBL_PROBABILIDAD' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'version', 'enum', true,'{/literal}{sugar_translate label='LBL_VERSION' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'etapas', 'enum', false,'{/literal}{sugar_translate label='LBL_ETAPAS' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'linea[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_LINEA' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'consecutivo_interno', 'varchar', false,'{/literal}{sugar_translate label='LBL_CONSECUTIVO_INTERNO' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'forma_pago', 'text', false,'{/literal}{sugar_translate label='LBL_FORMA_PAGO' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'seguimiento_mercadeo', 'text', false,'{/literal}{sugar_translate label='LBL_SEGUIMIENTO_MERCADEO' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'descuento', 'currency', false,'{/literal}{sugar_translate label='LBL_DESCUENTO' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'valor_real', 'currency', false,'{/literal}{sugar_translate label='LBL_VALOR_REAL' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'consecutivo_cliente', 'varchar', false,'{/literal}{sugar_translate label='LBL_CONSECUTIVO_CLIENTE' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'referencias', 'varchar', false,'{/literal}{sugar_translate label='LBL_REFERENCIAS' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'suma_mejor_estimado', 'bool', false,'{/literal}{sugar_translate label='LBL_SUMA_MEJOR_ESTIMADO' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'encargado_oferta', 'enum', false,'{/literal}{sugar_translate label='LBL_ENCARGADO_OFERTA' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'costo_personal', 'html', false,'{/literal}{sugar_translate label='LBL_COSTO_PERSONAL' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'costo_cotizacion_html', 'html', false,'{/literal}{sugar_translate label='LBL_COSTO_COTIZACION_HTML' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'costo_gastos', 'html', false,'{/literal}{sugar_translate label='LBL_COSTO_GASTOS' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'costo_categorias', 'html', false,'{/literal}{sugar_translate label='LBL_COSTO_CATEGORIAS' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'create_flag', 'bool', false,'{/literal}{sugar_translate label='LBL_CREATE_FLAG' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'consecutivo_automatico', 'varchar', false,'{/literal}{sugar_translate label='LBL_CONSECUTIVO_AUTOMATICO' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'contador_automatico', 'int', false,'{/literal}{sugar_translate label='LBL_CONTADOR_AUTOMATICO' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'anio_control', 'int', false,'{/literal}{sugar_translate label='LBL_ANIO_CONTROL' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'total_directos', 'int', false,'{/literal}{sugar_translate label='LBL_TOTAL_DIRECTOS' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'total_estudios', 'int', false,'{/literal}{sugar_translate label='LBL_TOTAL_ESTUDIOS' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'opportunities_project_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_PROJECT_1_FROM_PROJECT_TITLE' module='Opportunities' for_js=true}{literal}' );
