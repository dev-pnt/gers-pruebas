...
addToValidate('form_QuickCreate_Accounts', 'prefijo_consecutivo', 'varchar', false,'{/literal}{sugar_translate label='LBL_PREFIJO_CONSECUTIVO' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'identificacion', 'varchar', false,'{/literal}{sugar_translate label='LBL_IDENTIFICACION' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'exogena', 'varchar', false,'{/literal}{sugar_translate label='LBL_EXOGENA' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'impuestos', 'varchar', false,'{/literal}{sugar_translate label='LBL_IMPUESTOS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'tipo_identificacion', 'enum', false,'{/literal}{sugar_translate label='LBL_TIPO_IDENTIFICACION' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'tamanio_facturacion', 'enum', false,'{/literal}{sugar_translate label='LBL_TAMANIO_FACTURACION' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'rangos', 'enum', false,'{/literal}{sugar_translate label='LBL_RANGOS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'razon_social', 'varchar', false,'{/literal}{sugar_translate label='LBL_RAZON_SOCIAL' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'email_corporativo', 'varchar', false,'{/literal}{sugar_translate label='LBL_EMAIL_CORPORATIVO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'sector', 'enum', false,'{/literal}{sugar_translate label='LBL_SECTOR' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'sector_economico', 'enum', false,'{/literal}{sugar_translate label='LBL_SECTOR_ECONOMICO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'subsector_economico', 'multienum', false,'{/literal}{sugar_translate label='LBL_SUBSECTOR_ECONOMICO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'calificacion', 'enum', false,'{/literal}{sugar_translate label='LBL_CALIFICACION' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'total_vendido_con_gers', 'currency', false,'{/literal}{sugar_translate label='LBL_TOTAL_VENDIDO_CON_GERS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'relaciones_otras_empresas', 'text', false,'{/literal}{sugar_translate label='LBL_RELACIONES_OTRAS_EMPRESAS' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'project_accounts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_PROJECT_ACCOUNTS_1_FROM_PROJECT_TITLE' module='Accounts' for_js=true}{literal}' );
