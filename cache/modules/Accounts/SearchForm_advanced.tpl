...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='identificacion_advanced'>{sugar_translate label='LBL_IDENTIFICACION' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.identificacion_advanced.value) <= 0}
{assign var="value" value=$fields.identificacion_advanced.default_value }
{else}
{assign var="value" value=$fields.identificacion_advanced.value }
{/if}  
<input type='text' name='{$fields.identificacion_advanced.name}' 
    id='{$fields.identificacion_advanced.name}' size='30' 
    maxlength='20' 
    value='{$value}' title=''      >
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='prefijo_consecutivo_advanced'>{sugar_translate label='LBL_PREFIJO_CONSECUTIVO' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.prefijo_consecutivo_advanced.value) <= 0}
{assign var="value" value=$fields.prefijo_consecutivo_advanced.default_value }
{else}
{assign var="value" value=$fields.prefijo_consecutivo_advanced.value }
{/if}  
<input type='text' name='{$fields.prefijo_consecutivo_advanced.name}' 
    id='{$fields.prefijo_consecutivo_advanced.name}' size='30' 
    maxlength='10' 
    value='{$value}' title=''      >
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='tipo_identificacion_advanced'>{sugar_translate label='LBL_TIPO_IDENTIFICACION' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='tipo_identificacion_advanced' name='tipo_identificacion_advanced[]' options=$fields.tipo_identificacion_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.tipo_identificacion_advanced.value}
   	   	</td>
...
<input type='text' name='{$fields.phone_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='razon_social_advanced'>{sugar_translate label='LBL_RAZON_SOCIAL' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.razon_social_advanced.value) <= 0}
{assign var="value" value=$fields.razon_social_advanced.default_value }
{else}
{assign var="value" value=$fields.razon_social_advanced.value }
{/if}  
<input type='text' name='{$fields.razon_social_advanced.name}' 
    id='{$fields.razon_social_advanced.name}' size='30' 
    maxlength='36' 
    value='{$value}' title=''      >
   	   	</td>
