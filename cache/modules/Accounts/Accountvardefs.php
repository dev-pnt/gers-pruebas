 ...
 $GLOBALS["dictionary"]["Account"]=array (
  ...
  array (
    ...
    array (
      ...
      'vname' => 'LBL_TAMANIO_FACTURACION',
      'type' => 'enum',
      'options' => 'tamanio_facturacion_list',
      'len' => '255',
      'audited' => true,
    ),
    'rangos' => 
    ...
    array (
      ...
      'vname' => 'LBL_SUBSECTOR_ECONOMICO',
      'type' => 'multienum',
      'options' => 'subsector_list',
      'len' => '255',
      'audited' => true,
    ),
    'calificacion' => 
    ...
    'total_vendido_con_gers' => 
    array (
      'name' => 'total_vendido_con_gers',
      'vname' => 'LBL_TOTAL_VENDIDO_CON_GERS',
      'type' => 'currency',
      'dbType' => 'double',
      'importable' => 'required',
      'audited' => true,
    ...
    'relaciones_otras_empresas' => 
    array (
      'name' => 'relaciones_otras_empresas',
      'vname' => 'LBL_RELACIONES_OTRAS_EMPRESAS',
      'type' => 'text',
      'rows' => 3,
      'cols' => 70,
      'audited' => true,
