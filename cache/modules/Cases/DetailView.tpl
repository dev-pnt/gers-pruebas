...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.canal_ingreso.hidden}
...
{if is_string($fields.canal_ingreso.options)}
<input type="hidden" class="sugar_field" id="{$fields.canal_ingreso.name}" value="{ $fields.canal_ingreso.options }">
{ $fields.canal_ingreso.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.canal_ingreso.name}" value="{ $fields.canal_ingreso.value }">
{ $fields.canal_ingreso.options[$fields.canal_ingreso.value]}
{/if}
{/if}
</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.fecha_respuesta.hidden}
...
{if strlen($fields.fecha_respuesta.value) <= 0}
{assign var="value" value=$fields.fecha_respuesta.default_value }
{else}
{assign var="value" value=$fields.fecha_respuesta.value }
{/if}
<span class="sugar_field" id="{$fields.fecha_respuesta.name}">{$value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.fecha_est_solucion.hidden}
...
{if strlen($fields.fecha_est_solucion.value) <= 0}
{assign var="value" value=$fields.fecha_est_solucion.default_value }
{else}
{assign var="value" value=$fields.fecha_est_solucion.value }
{/if}
<span class="sugar_field" id="{$fields.fecha_est_solucion.name}">{$value}</span>
{/if}
</td>
</tr>
{/capture}
...
{/if}
<input type="checkbox" class="checkbox" name="{$fields.satisfecho.name}" id="{$fields.satisfecho.name}" value="$fields.satisfecho.value" disabled="true" {$checked}>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.fecha_solucion.hidden}
...
{if strlen($fields.fecha_solucion.value) <= 0}
{assign var="value" value=$fields.fecha_solucion.default_value }
{else}
{assign var="value" value=$fields.fecha_solucion.value }
{/if}
<span class="sugar_field" id="{$fields.fecha_solucion.name}">{$value}</span>
{/if}
</td>
</tr>
{/capture}
...
<span class="sugar_field" id="{$fields.solucion.name|escape:'html'|url2html|nl2br}">{$fields.solucion.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}</span>
{/if}
</td>
</tr>
{/capture}
