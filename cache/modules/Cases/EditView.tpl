...
{capture name="label" assign="label"}{sugar_translate label='LBL_DEPARTAMENT_ENCARGADO' module='Cases'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CANAL_INGRESO' module='Cases'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.canal_ingreso.name}" 
id="{$fields.canal_ingreso.name}" 
title=''       
>
{if isset($fields.canal_ingreso.value) && $fields.canal_ingreso.value != ''}
{html_options options=$fields.canal_ingreso.options selected=$fields.canal_ingreso.value}
{else}
{html_options options=$fields.canal_ingreso.options selected=$fields.canal_ingreso.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.canal_ingreso.options }
{capture name="field_val"}{$fields.canal_ingreso.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.canal_ingreso.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.canal_ingreso.name}" 
id="{$fields.canal_ingreso.name}" 
title=''          
>
{if isset($fields.canal_ingreso.value) && $fields.canal_ingreso.value != ''}
...
<input
id="{$fields.canal_ingreso.name}-input"
name="{$fields.canal_ingreso.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.canal_ingreso.name}-image"></button><button type="button"
id="btn-clear-{$fields.canal_ingreso.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.canal_ingreso.name}-input', '{$fields.canal_ingreso.name}');sync_{$fields.canal_ingreso.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.canal_ingreso.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.canal_ingreso.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.canal_ingreso.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.canal_ingreso.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.canal_ingreso.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.canal_ingreso.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.canal_ingreso.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.canal_ingreso.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.canal_ingreso.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_FECHA_RESPUESTA' module='Cases'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<span class="dateTime">
{assign var=date_value value=$fields.fecha_respuesta.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.fecha_respuesta.name}" id="{$fields.fecha_respuesta.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.fecha_respuesta.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.fecha_respuesta.name}",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.fecha_respuesta.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
{capture name="label" assign="label"}{sugar_translate label='LBL_FECHA_EST_SOLUCION' module='Cases'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<span class="dateTime">
{assign var=date_value value=$fields.fecha_est_solucion.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.fecha_est_solucion.name}" id="{$fields.fecha_est_solucion.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.fecha_est_solucion.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.fecha_est_solucion.name}",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.fecha_est_solucion.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
startWeekday: {$CALENDAR_FDOW|default:'0'},
step : 1,
...
{capture name="label" assign="label"}{sugar_translate label='LBL_WORK_LOG' module='Cases'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_SATISFECHO' module='Cases'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strval($fields.satisfecho.value) == "1" || strval($fields.satisfecho.value) == "yes" || strval($fields.satisfecho.value) == "on"} 
{assign var="checked" value="CHECKED"}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.satisfecho.name}" value="0"> 
<input type="checkbox" id="{$fields.satisfecho.name}" 
name="{$fields.satisfecho.name}" 
value="1" title='' tabindex="0" {$checked} >
<td valign="top" id='fecha_solucion_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_FECHA_SOLUCION' module='Cases'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<span class="dateTime">
{assign var=date_value value=$fields.fecha_solucion.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.fecha_solucion.name}" id="{$fields.fecha_solucion.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.fecha_solucion.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.fecha_solucion.name}",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.fecha_solucion.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
startWeekday: {$CALENDAR_FDOW|default:'0'},
step : 1,
...
{capture name="label" assign="label"}{sugar_translate label='LBL_SOLUCION' module='Cases'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if empty($fields.solucion.value)}
{assign var="value" value=$fields.solucion.default_value }
{else}
{assign var="value" value=$fields.solucion.value }
{/if}  
<textarea  id='{$fields.solucion.name}' name='{$fields.solucion.name}'
rows="4" 
cols="60" 
title='' tabindex="0" 
 >{$value}</textarea>
...
addToValidate('EditView', 'departamento_encargado', 'enum', false,'{/literal}{sugar_translate label='LBL_DEPARTAMENT_ENCARGADO' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'canal_ingreso', 'enum', false,'{/literal}{sugar_translate label='LBL_CANAL_INGRESO' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'calificacion', 'enum', false,'{/literal}{sugar_translate label='LBL_CALIFICACION' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'satisfecho', 'bool', false,'{/literal}{sugar_translate label='LBL_SATISFECHO' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'solucion', 'text', false,'{/literal}{sugar_translate label='LBL_SOLUCION' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'fecha_respuesta', 'date', false,'{/literal}{sugar_translate label='LBL_FECHA_RESPUESTA' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'fecha_solucion', 'date', false,'{/literal}{sugar_translate label='LBL_FECHA_SOLUCION' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'fecha_est_solucion', 'date', false,'{/literal}{sugar_translate label='LBL_FECHA_EST_SOLUCION' module='Cases' for_js=true}{literal}' );
