...
<li><a id="tab0" href="javascript:void(0)"><em>{sugar_translate label='DEFAULT' module='ProjectTask'}</em></a></li>

<li><a id="tab1" href="javascript:void(0)"><em>{sugar_translate label='LBL_DETAILVIEW_PANEL1' module='ProjectTask'}</em></a></li>
</ul>
...
<span class="sugar_field" id="{$fields.anticipos.name}">
{sugar_number_format var=$fields.anticipos.value  }
</span>
{/if}
</td>
</tr>
...
{sugar_number_format var=$fields.estimated_effort.value  }
</span>
{/if}
</td>
{counter name="fieldsUsed"}
...
{sugar_number_format var=$fields.actual_effort.value  }
</span>
{/if}
</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.detalle_horas.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_DETALLE_HORAS' module='ProjectTask'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%' colspan='3' >
{if !$fields.detalle_horas.hidden}
{counter name="panelFieldCount"}
<span id="detalle_horas" class="sugar_field">{rep_horas id_tarea=$fields.id.value}</span>
{/if}
</td>
</tr>
{/capture}
