...
addToValidate('CalendarEditView', 'tipo', 'enum', true,'{/literal}{sugar_translate label='LBL_TIPO' module='Meetings' for_js=true}{literal}' );
addToValidate('CalendarEditView', 'suma', 'bool', false,'{/literal}{sugar_translate label='LBL_SUMA' module='Meetings' for_js=true}{literal}' );
