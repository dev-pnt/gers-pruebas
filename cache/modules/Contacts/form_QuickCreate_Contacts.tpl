...
addToValidate('form_QuickCreate_Contacts', 'twitter', 'varchar', false,'{/literal}{sugar_translate label='LBL_TWITTER' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'correos_gers', 'bool', false,'{/literal}{sugar_translate label='LBL_CORREOS_GERS' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'tips_del_trato', 'text', false,'{/literal}{sugar_translate label='LBL_TIPS_TRATO' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'posicion_gers', 'enum', false,'{/literal}{sugar_translate label='LBL_POSICION_GERS' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'contacto_area', 'multienum', false,'{/literal}{sugar_translate label='LBL_CONTACTO_AREA' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'rol_negociacion', 'enum', false,'{/literal}{sugar_translate label='LBL_ROL_NEGOCIACION' module='Contacts' for_js=true}{literal}' );
