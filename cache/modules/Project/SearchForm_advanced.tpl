...
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_estimated_start_date_advanced) && !empty($smarty.request.estimated_start_date_advanced)}{$smarty.request.estimated_start_date_advanced}{else}{$smarty.request.range_estimated_start_date_advanced}{/if}' title=''   size="11" style="width:100px !important;">
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_estimated_start_date_advanced }' title=''  tabindex='' size="11" style="width:100px !important;">
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.estimated_start_date_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_estimated_start_date_advanced }' title=''  tabindex='' size="11" style="width:100px !important;" maxlength="10">
...
{rdelim});
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_USER_ID' module='Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{php}$this->_tpl_vars['user_options'] = get_user_array(false);{/php}
{html_options name='assigned_user_id_advanced[]' options=$user_options size="6" style="width: 150px" multiple="1" selected=$fields.assigned_user_id_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='project_accounts_1_name_advanced'>{sugar_translate label='LBL_PROJECT_ACCOUNTS_1_FROM_ACCOUNTS_TITLE' module='Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="{$fields.project_accounts_1_name_advanced.name}"  class="sqsEnabled"   id="{$fields.project_accounts_1_name_advanced.name}" size="" value="{$fields.project_accounts_1_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.project_accounts_1accounts_idb_advanced.name}" value="{$fields.project_accounts_1accounts_idb_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.project_accounts_1_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.project_accounts_1_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"project_accounts_1accounts_idb_advanced","name":"project_accounts_1_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.project_accounts_1_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.project_accounts_1_name_advanced.name}.value = ''; this.form.{$fields.project_accounts_1accounts_idb_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='departamento_encargado_advanced'>{sugar_translate label='LBL_DEPARTAMENTO_ENCARGADO' module='Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{html_options id='departamento_encargado_advanced' name='departamento_encargado_advanced[]' options=$fields.departamento_encargado_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.departamento_encargado_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='linea_advanced'>{sugar_translate label='LBL_LINEA' module='Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='linea_advanced' name='linea_advanced[]' options=$fields.linea_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.linea_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='referencias_advanced'>{sugar_translate label='LBL_REFERENCIAS' module='Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.referencias_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_estimated_end_date_advanced }' title=''  tabindex='' size="11" style="width:100px !important;">
{capture assign="other_attributes"}align="absmiddle" border="0" id="start_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.estimated_end_date_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_estimated_end_date_advanced }' title=''  tabindex='' size="11" style="width:100px !important;" maxlength="10">
{capture assign="other_attributes"}align="absmiddle" border="0" id="end_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{html_options id='status_advanced' name='status_advanced[]' options=$fields.status_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.status_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='description_advanced'>{sugar_translate label='LBL_DESCRIPTION' module='Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
